...
export function FloorEditor({
    ...
    return(
        <>
        <div key={floorIndex}>
            <h2>{floorIndex === 0 ? "S.E.Q" : `S.E.T ${floorIndex + 1}º Andar`}</h2>
            <label>
              Número de computadores neste andar:
              <input type="number"
                onChange={(e) => handleTemp(floorIndex, "computers", { computers: Number(e.target.value) })}
              /> <br /> <br />
              {settings.haveCameras && (
                <label>
                  Número de câmeras neste andar:
                  <input type="number"
                    onChange={(e) => handleTemp(floorIndex, "cameras", { cameras: Number(e.target.value) })}
                  /> <br />
                  Selecione a tecnologia da(s) câmera(s):
                  <select onChange={(e) => handleTemp(floorIndex, "cameras", { technologyCameras: String(e.target.value) })}>
                  ...
                  {temp.cameras[floorIndex]?.technologyCameras === "ip_com_poe" && (
                    <label>
                      ...
                      <input type="number"
                        onChange={(e) => handleTemp(floorIndex, "cameras", { energyCameras: Number(e.target.value) })}
                      />
                    </label>
                  )
                  }
              ...
              {settings.havePhones && (
                <label>
                  ...
                  <input type="number"
                    onChange={(e) => handleTemp(floorIndex, "phones", { phones: Number(e.target.value) })}
                  /> <br />
                  Selecione a tecnologia do(s) telefone(s):
                  <select onChange={(e) => handleTemp(floorIndex, "phones", { isPhonePoE: Boolean(e.target.value) })}>
                    <option value="">Selecione</option>
                  ...
                  {temp.phones[floorIndex]?.isPhonePoE === true && (
                    <>
                      <label>
                        ...
                        <input type="number"
                          onChange={(e) => handleTemp(floorIndex, "phones", { energyPhones: Number(e.target.value) })}
                        />
                        <br />
                      </label>
                    </>
              ...
              {settings.haveAccessPoints && (
                <label>
                  ...
                  <input type="number"
                    min="1"
                    onChange={(e) => handleTemp(floorIndex, "accessPoints", { acessPoints: Number(e.target.value) })}
                  /><br />
                  Selecione se é com PoE ou sem: 
                  <select
                  onChange={(e)=>
                    handleTemp(floorIndex, "accessPoints", {isAccessPointsPoE: Boolean(e.target.value)})
                  }>
                    <option value="">Selecione</option>
                  ...
                  {temp.accessPoints[floorIndex].isAccessPointsPoE === true &&(
                    <label>
                      ...
                      <input type="number"
                      onChange={(e)=> handleTemp(floorIndex, "accessPoints", {energyAcessPoints : Number(e.target.value)})}
                      />
                    </label>
                  )
                  }
              ...
              {settings.haveAccessControllers && (
                <label>
                  ...
                  <input type="number"
                    onChange={(e) => handleTemp(floorIndex, "accessControllers", { accessControllers: Number(e.target.value) })}
                  /> <br />
                  Selecione o tipo de alimentação:
                  <select onChange={(e) => handleTemp(floorIndex, "accessControllers", { isAcessControllersPoE: e.target.value === "true" })}>
                    <option value="">Selecione</option>
                  ...
                  <input type="number"
                    onChange={(e) => handleTemp(floorIndex, "accessControllers", { accessControllerNetworkPorts: Number(e.target.value) })}
                  />
                  <br />
                  {temp.accessControllers[floorIndex]?.isAcessControllersPoE && (
                    <label>
                      ...
                      <input type="number"
                        onChange={(e) => handleTemp(floorIndex, "accessControllers", { energyAccessControllers: Number(e.target.value) })}
                      />
                      <br />
                    </label>
                  )
